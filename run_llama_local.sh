...
export OTEL_SERVICE_NAME="chatui-llama"
export OTEL_RESOURCE_ATTRIBUTES="service.namespace=${SERVICE_NAMESPACE},deployment.environment=${SERVICE_ENVIRONMENT},host.name=frontend"
